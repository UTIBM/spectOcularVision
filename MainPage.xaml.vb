...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class MainPage
        ...
        Public Property viewModel As New Dictionary(Of Type, ViewModelBase)
        ...
        Private Sub _LoadScenario(ByVal scenarioClass As Type)
        ...
        Private Sub Scenarios_SelectionChanged(ByVal sender As Object, ByVal e As SelectionChangedEventArgs)
            If Scenarios.SelectedItem IsNot Nothing Then
                ...
                _LoadScenario(scenario.ClassType)
                InvalidateSize()
